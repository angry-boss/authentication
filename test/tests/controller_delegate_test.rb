require 'authentication/controller_delegate'
...
class ControllerDelegateTest < Minitest::Test
  ...
  def setup
    ...
    @delegate = Authentication::ControllerDelegate.new(@controller)
  end
  ...
  def test_users_can_be_logged_in
    ...
    assert_equal Authentication::Session, @delegate.auth_session.class
  end
